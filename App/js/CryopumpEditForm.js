    ...
    Instance:{
        ...
        iniComponents : function(){
            ...
            host.block3.append(
                ...
                .setLabelSize("18em")
                .setLabelGap("0em")
                .setLabelCaption("更換Pugge Valva塞心")
                .setLabelVAlign("middle")
                .setCheckBox(true)
                .setValue("")
                .setCustomStyle({
            ...
            host.block5.append(
                ...
                .setHAlign("right")
                .setIconPos("right")
                .setCaption("2.管線配接符合Pump要求  Pass")
            );
            ...
            host.block5.append(
                ...
                .setHAlign("right")
                .setIconPos("right")
                .setCaption("7.Test完成後,Helium Side Purge    Pass")
            );
            ...
            host.block5.append(
                ...
                .setHAlign("right")
                .setIconPos("right")
                .setCaption("9.15k Array間距調整檢查(不可接觸)Pass")
            );
            ...
            host.block5.append(
                ...
                .setHAlign("right")
                .setIconPos("right")
                .setCaption("11.Pump入庫前外觀檢查 Pass")
            );
        ...
        */
        _savebtn_onclick:function(profile, e, src, value){
            ...
            var db = ns.rdb, dbname = "rdb",finishState = ns.finishStatus.getUIValue();
    ...
    _d1_afteruivalueset:function(profile, oldValue, newValue, force, tag, tagVar){
        ...
        */
        _crossheadbtn_onclick:function(profile, e, src, value){
            ...
            utils.showCrossheadEditFormXH(xh);
        },
