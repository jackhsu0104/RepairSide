/*************************************************************************************************
 程式代號：RepairSide
 程式名稱：App/js/ShiCryopumpEditForm.js
...
xui.Class('App.ShiCryopumpEditForm', 'xui.Module',{
    Instance:{
        ...
        iniComponents : function(){
            ...
            host.block1.append(
                xui.create("xui.UI.RadioBox")
                .setHost(host,"xui_ui_radiobox377")
                .setDataBinder("rdb2")
                .setDataField("Type")
                .setItems([
                    {
            ...
            host.xui_ui_block178.append(
                ...
                .setDataBinder("rdb2")
                .setDataField("Vent Valve#1清潔/更換")
                .setItems([
                    {
                        "id" : "0",
                        "caption" : "清潔",
            ...
            host.block3.append(
                ...
                .setDataBinder("rdb2")
                .setDataField("RTD Line正確固定並保持彈性")
                .setItems([
                    {
                        "id" : "Y",
                        "caption" : "Y",
            ...
            host.block4.append(
                ...
                .setDataBinder("rdb2")
                .setDataField("”X” head S/N C#2 Y/N")
                .setItems([
                    {
                        "id" : "Y",
                        "caption" : "Y",
            ...
            host.block4.append(
                ...
                .setDataBinder("rdb2")
                .setDataField("Purge Helium Side#2")
                .setItems([
                    {
                        "id" : "-08",
                        "caption" : "-08",
            ...
            host.block4.append(
                ...
                .setDataBinder("rdb2")
                .setDataField("Purge Helium Side#3")
                .setItems([
                    {
                        "id" : "-08",
                        "caption" : "-08",
            ...
            host.xui_ui_div973.append(
                ...
                .setDataBinder("rdb2")
                .setDataField("Spec= 100k±1k Pass")
                .setIsFormField(false)
                .setItems([
                    {
                        "id" : "Pass",
            ...
            host.xui_ui_div1275.append(
                xui.create("xui.UI.RadioBox")
                .setHost(host,"xui_ui_radiobox623")
                .setDataBinder("rdb2")
                .setDataField("Wamup Pass")
                .setIsFormField(false)
                .setItems([
                    {
                        "id" : "Pass",
            ...
            host.xui_ui_div1276.append(
                xui.create("xui.UI.RadioBox")
                .setHost(host,"xui_ui_radiobox624")
                .setDataBinder("rdb2")
                .setDataField("真空值Pass")
                .setIsFormField(false)
                .setItems([
                    {
                        "id" : "Pass",
        ...
        */
        _dialog_onshow:function(profile){
          ...
          //  xui.alert("onShowDialog");  
            console.log(utils.createDDL(ns.dialog,"SHI CryoPump維修工單"));
        },
            /**
         * Fired when user click it
         * @method onClick [xui.UI.Button event]
